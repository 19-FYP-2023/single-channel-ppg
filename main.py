...
def train_ucibp_fnet(dataset="ucibp"):
        ...
        logging.info(f"Un-normalized the output")
        logging.info("Using FNet")
        logging.info(f"Batch size changed to 128")
        logging.info(f"Train test split changed form 0.8-0.1-0.1 to 0.6-0.2-0.2")
        # dataset configuration
