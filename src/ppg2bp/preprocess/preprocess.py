...
paths = [
    "data-captures/data02052019/sensor2",
    "data-captures/data02052019",
    "data-captures/data16012019",
]
...
data_entc.to_csv(
    "dataset/paraqum-dataset/good_signal_labels_with_paths.csv", index=False
)
