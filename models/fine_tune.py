...
class FineTuneSBP(nn.Module):
    def __init__(self, in_channels, mid_channels, out_channels, downsampling_factor=2):
        ...
        self.fine_tune = nn.Sequential(
            nn.Conv1d(in_channels=in_channels, out_channels=mid_channels, kernel_size=4, stride=4),
            nn.BatchNorm1d(mid_channels),
            nn.ReLU(),
            nn.Conv1d(in_channels=mid_channels, out_channels=out_channels, kernel_size=4, stride=4),
            nn.ReLU(),
